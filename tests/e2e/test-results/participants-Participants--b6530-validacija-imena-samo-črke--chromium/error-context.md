...
- Name: participants.spec.ts >> Participants >> PRT-13 — Sidebar — validacija imena (samo črke)
- Location: specs/participants.spec.ts:188:2
...
Call log:
  - waiting for getByRole('row', { name: /test_participant_2/ })
