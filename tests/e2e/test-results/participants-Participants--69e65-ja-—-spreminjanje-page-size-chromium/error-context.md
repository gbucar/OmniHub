...
- Name: participants.spec.ts >> Participants >> PRT-05 — Paginacija — spreminjanje page size
- Location: specs/participants.spec.ts:60:2
...
Call log:
  - waiting for getByLabel('Records per page')
