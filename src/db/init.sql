...
SET search_path TO pg_catalog,public,auth,data;
-- ddl-end --
...
ALTER TABLE data.observations ADD CONSTRAINT observations_datastreams_fk FOREIGN KEY (datastream_id)
...
-- object: grant_rawd_ce95c97fcb | type: PERMISSION --
